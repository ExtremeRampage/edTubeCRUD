...
<c:url value="/videos/records" var="vidRecordsUrl"/>
<c:url value="/videos/tree?videoID=6EEjDV2NKEY" var="treeTest"/>
...
<head>
	...
	$(function() {
		...
		urlHolder.vidrecords = '${vidRecordsUrl}';
//		loadTable();
		loadVidTable();
...
<body>
	...
	<div id='controlBar'>
		...
		<input type='button' value='Reload' id='reloadBtn' /><br><br>
	</div>
